                ...
                <div className="w-full 2xl:pl-8 xl:pt-1">
                  ...
                  <div className="w-full md:w-10/12 mt-3">
                    <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider">
                      Summer holidays are always tough for children living with
                      chronic hunger. The thought of spending 10 weeks without
                      enough food will cause fear in many of our vulnerable
                      kids.
                    </h2>
            ...
            <div className="w-full lg:w-1/2   xl:pt-10 lg:pl-24">
              <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                ...
                <div className="w-full 2xl:w-8/12 mt-3">
                  <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider">
                    $500 feeds one child for the entire summer.
                  </h2>
                  ...
                  <div className="py-5">
                    <button className="py-3 md:py-5 px-5 md:px-10 bg-gray-500 text-white hover:opacity-90 ease-in duration-150 text-sm md:text-lg tracking-wider font-semibold">
                      Send
                    </button>
                  </div>
                </div>
